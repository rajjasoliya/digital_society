...
<center><caption><h2>Admin Confirmation</h2></caption></center>
    ...
    <button type="submit" name="login">Log in</button>&nbsp;&nbsp;&nbsp;<button><a style="color:white;" href="logout.php">Logout Admin</a></button>
    </form>
    <?PHP
